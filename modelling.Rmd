...
model_dat1115$`Number of underlying diseases` =  fct_collapse(model_dat1115$`Number of underlying diseases`,
                                                   "2" = c("2","3", "4", "5"))
...
model_dat1115$`Number of previous treatment drugs` =
  fct_collapse(model_dat1115$`Number of previous treatment drugs`,
...
model_dat1115$`Number of combined drugs` =
  fct_collapse(model_dat1115$`Number of combined drugs`,
                                                   "1" = c("1", "2","3","4","5","6") 
  )

## 0为一类；1-4为一类，然后是否可以再分亚组1-2、3-4.

model_dat1115$`Number of combined antitumor drugs` =
  fct_collapse(model_dat1115$`Number of combined antitumor drugs`,
                                                   "1" = c("1","2","3","4") 
  )

## KPS 合并 70 及以下为一类； 80为一类，90及以上为一类
model_dat1115$`KPS score` =
  fct_collapse(model_dat1115$`KPS score` %>% as.character,
                                                   "70" = c("30","40","50","60","70") ,
 "90" = c("90","100")          
  )
  

miss_var_summary(model_dat1115)

model_dat1115$outcome <- as.factor(model_dat1115$outcome)

```

## Create dummy variable
```{r}
dummyModel <- dummyVars(as.factor(outcome) ~ ., data = model_dat1115)
model_dat1115X <- as.data.frame(predict(dummyModel, newdata = model_dat1115))
...
model_dat1115_new <- cbind(model_dat1115$outcome, model_dat1115X)
...
set.seed(355)
trainIndex <- createDataPartition(model_dat1115_new$outcome, p = 0.7, list = FALSE)
trainingSet <- model_dat1115_new[trainIndex,]
testSet <- model_dat1115_new[-trainIndex,]

model_dat1115_new$outcome %>% table() ## 48/190=0.2526
...
```{r eval=FALSE, include=FALSE}
featurePlot(x = model_dat1115[,c("Height")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Temperature")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Smoking")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("KPS score")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Number of underlying diseases")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Previous lung disease")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("ICIs drugs")],
            y = model_dat1115$outcome,
            plot = "box")
...
```{r eval=FALSE, include=FALSE}
featurePlot(x = model_dat1115[,c("ICIs dosage")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Course of treatment")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Number of combined antitumor drugs")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Number of combined drugs")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Previous treatment_yn")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Number of previous treatment drugs")],
            y = model_dat1115$outcome,
            plot = "box")
...
```{r eval=FALSE, include=FALSE}
featurePlot(x = model_dat1115[,c("Percentage of CD4 lymphocytes")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Percentage of NK cell")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Percentage of  T lymphocytes")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Percentage of eosinophilus cells")],
            y = model_dat1115$outcome,
            plot = "box")
...
featurePlot(x = model_dat1115[,c("Percentage of neutrophilic granulocyte")],
            y = model_dat1115$outcome,
            plot = "box")
...
```{r eval=FALSE, include=FALSE}
nearZeroVar(model_dat1115, freqCut = 95/5, uniqueCut = 10,names = TRUE)
```
